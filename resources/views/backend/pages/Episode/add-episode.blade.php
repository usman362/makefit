          ...
          <div class="col-sm-12">
             <div class="iq-card">
                ...
                <div class="iq-card-body">
                   <form action="{{URL::to('episode')}}" method="POST" enctype="multipart/form-data">
                     @csrf
                      <div class="row">
                         <div class="col-lg-7">
                            <div class="row">
                               ...
                               <div class="col-md-6 form-group">
                                  <input type="number" class="form-control" name="ep_no" placeholder="Episode No." required>
                               </div>
                               <div class="col-md-6 form-group">
                                  <input type="text" class="form-control" name="ep_name" placeholder="Episode Name" required>
                               </div>
                               ...
                               <div class="col-md-6 form-group">
                                  <input type="text" class="form-control" name="r_time_minute" placeholder="Running Time in Minutes" required>
                               </div>
                               <div class="col-md-6 form-group">
                                  <input class="form-control date-input basicFlatpickr flatpickr-input" type="text" name="date" placeholder="Selete Date" required>
                               </div>
